package Exceptions.Sem02.HW.task3;
...
public class Prog {
    ...
    public static void printSum(Integer a, Integer b) { //И зачем тут был throws FileNotFoundException, если работы с файлами тут нет?
        System.out.println(a + b);
    }
